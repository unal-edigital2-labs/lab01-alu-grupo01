...
set_property PACKAGE_PIN V10 [get_ports {portA[2]}]
set_property PACKAGE_PIN U11 [get_ports {portA[1]}]
set_property PACKAGE_PIN U12 [get_ports {portA[0]}]
set_property PACKAGE_PIN H6 [get_ports {portB[2]}]
set_property PACKAGE_PIN T13 [get_ports {portB[1]}]
set_property PACKAGE_PIN R16 [get_ports {portB[0]}]
set_property PACKAGE_PIN L16 [get_ports {opcode[1]}]
set_property PACKAGE_PIN J15 [get_ports {opcode[0]}]
set_property PACKAGE_PIN N14 [get_ports {an[3]}]
set_property PACKAGE_PIN J13 [get_ports {an[2]}]
set_property PACKAGE_PIN K15 [get_ports {an[1]}]
set_property PACKAGE_PIN H17 [get_ports {an[0]}]

set_property IOSTANDARD LVCMOS33 [get_ports {an[4]}]
set_property PACKAGE_PIN V11 [get_ports {an[4]}]
